...
Okay, so we sort of know what to expect. Next, let's take a look at the TMB code that we'll use to actually fit the model, and then we'll look at the result (all code can be viewed [here] <INSERT LINK>).
